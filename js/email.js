...
function sendRequest() {
  ...
  try {
    ...
    jQuery("#contactWrapper").append(
      '<div class="success"><h4>Correo fue enviado exitosamente!</h4><br><p>Gracias por reservar en linea <strong>' +
        decodeURIComponent(name) +
        "</strong>! Tu correo se mando exitosamente y estaremos en contacto contigo lo mas pronto posible.</p></div>"
    );
  }
}
    ...
    if ($j("#contactform #name").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #name")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">Por favor ingresa tu nombre</label>'
          );
    ...
    if (validate_email($j("#contactform #email").val()) == false) {
      ...
      if (!hasClass)
        $j("#contactform #email")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">Por favor ingresa un correo electronico valido.</label>'
          );
    ...
    if ($j("#contactform #subject").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #subject")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">Ocupas ingresar un asunto!</label>'
          );
    ...
    if ($j("#contactform #body").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #body")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">Ocupas ingresar un mensaje!</label>'
          );
    ...
    if ($j("#contactform #name").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #name")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">Por favor ingresa tu primer nombre</label>'
          );
      $j("#contactform #name").focus();
      //return false;
      errors++;
